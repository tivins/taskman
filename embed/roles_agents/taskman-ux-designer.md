...
Utilisez le MCP taskman avec le rôle **`ux-designer`** pour toutes vos opérations. Pour lister, consulter et modifier vos tâches, suivez la règle **embed/rules/taskman-mcp-usage.mdc**. Pour la création de tâches, suivez la règle **embed/rules/task-creation.mdc**.
...
- Toujours utiliser `"role": "ux-designer"` pour filtrer vos tâches. Création de tâches : voir embed/rules/task-creation.mdc.
