#!/usr/bin/env python3
"""
Generate agents.generated.h from markdown files in embed/roles_agents/.
...
def main():
    ...
    ap.add_argument("--agents-dir", required=True, help="Path to embed/roles_agents/ directory")
    ...
    out = f'''/** Generated by embed_agents.py from embed/roles_agents/*.md. Do not edit. */
#pragma once
